...
### Como ejecutar
Para utilizar el probador, tendrá que seguir estos pasos:
- Descargar el archivo Zip y descomprimir la carpeta en su máquina 
- Asegurarse de tener instalado cyprees correctameneyte y sus dependencias, sino es asi, seguir el tutorail contenido en la siguiente pagina https://thesoftwaredesignlab.github.io/AutTestingCodelabs/cypress-tutorial/index.html#0
...
## The testers
Cypress es un corredor de pruebas E2E construido sobre JavaScript. Utiliza esta tecnología debido a la facilidad para la gestión de páginas web en una variedad de navegadores, incluyendo Chrome, Canarias, Edge, electrón, etc. y la funcionalidad de registro y reproducción. 
